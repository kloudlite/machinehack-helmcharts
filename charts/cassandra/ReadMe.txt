...
metadata:
  ...
  labels:
    ...
    helm.sh/chart: cassandra-12.1.3
spec:
  podSelector:
    matchLabels:
      app.kubernetes.io/instance: my-cassandra
...
type: Opaque
data:
  cassandra-password: "S3ZkT3VJanpCZQ=="
---
    ...
    spec:
      ...
      containers:
        - name: cassandra
          ...
          image: docker.io/bitnami/cassandra:5.0.3-debian-12-r0
          ...
          env:
            ...
            - name: CASSANDRA_SEEDS
              value: "my-cassandra-0.my-cassandra-headless.cassandra.svc.cluster.local"

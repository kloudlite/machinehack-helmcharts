    ...
    spec:
      ...
      containers:
        - name: post-job
          ...
          args:
            - |+
              root_password=$(kubectl get secrets/{{ .Release.Name }} -n {{ .Release.Namespace }} -o json | jq -r '.data."neo4j-password"' | base64 -d)
              ...
              stringData:
                ...
                NEO4J_PASSWORD: "$root_password"
                NEO4J_URL: "bolt://neo4j:$root_password@{{ .Values.neo4j.expose.host }}:$port"
              EOF

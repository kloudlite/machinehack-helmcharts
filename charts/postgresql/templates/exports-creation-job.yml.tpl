    ...
    spec:
      ...
      containers:
        - name: post-job
          ...
          args:
            - |+
              root_password=$(kubectl get secrets/{{.Release.Name}} -n {{.Release.Namespace}} -o json | jq -r '.data."postgres-password"' | base64 -d)
              ...
              stringData:
                ...
                POSTGRES_HOST: {{.Values.postgresql.expose.host | quote }}
                POSTGRES_PORT: "$port"
              EOF
